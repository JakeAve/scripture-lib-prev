...
Deno.test("Puts verses in chronological order", () => {
  ...
  const expected = {
    ...
    link: "https://www.churchofjesuschrist.org/study/scriptures/bofm/1-ne/3?lang=eng&id=p1-p2,p7,p12-p10#p1",
...
Deno.test("Will set chapter to 1 when there's only one chapter", () => {
  ...
  const expected = {
    ...
    link: "https://www.churchofjesuschrist.org/study/scriptures/ot/obad/1?lang=eng",
    reference: "Obadiah 1",
    verses: [],
  } as Reference;
...
Deno.test("Will link to book if no chapter or verses are provided", () => {
  ...
  const expected = {
    ...
    chapter: undefined,
    content: undefined,
    link: "https://www.churchofjesuschrist.org/study/scriptures/nt/john?lang=eng",
    reference: "John",
    verses: [],
  } as Reference;
...
Deno.test("Will remove chapter if it doesn't exist", () => {
  ...
  const expected = {
    ...
    chapter: undefined,
    content: undefined,
    link: "https://www.churchofjesuschrist.org/study/scriptures/nt/titus?lang=eng",
    reference: "Titus",
    verses: [],
  } as Reference;
...
Deno.test("Will lower verses if they do not exist in the chapter", () => {
  ...
  const expected = {
    ...
    link: "https://www.churchofjesuschrist.org/study/scriptures/dc-testament/dc/2?lang=eng&id=p1-p3#p1",
...
Deno.test(
  ...
  () => {
    ...
    const expected = {
      ...
      chapter: 1,
      content: "hi",
      link: "https://www.churchofjesuschrist.org/study/scriptures/bofm/enos/1?lang=eng",
      reference: "Enos 1",
      verses: [],
    } as Reference;
